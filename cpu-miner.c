...
static void stratum_gen_work(struct stratum_ctx *sctx, struct work *work)
{
  ...
  printf("\n");
    ...
    //for (i = 0; i < 8; i++)
    //{
    //    printf("[%u]",  work->data[9+i]);
    //}
    //printf("\n");
    printf("\n");
    printf("[%u]", work->data[0]);
    printf("\n");
    for (i = 1; i < 9 ; i++)
    {
        printf("[%u]", work->data[i]);
    }
    printf("\n");
    for (i = 9; i < 9+8 ; i++)
    {
    ...
    printf("\n");
    printf("[%u]", work->data[17]);
    printf("\n");
    printf("[%u]", work->data[18]);
    printf("\n");
    printf("[%u]", work->data[19]);
    printf("\n");
	}
